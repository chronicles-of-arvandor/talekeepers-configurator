...
export function displayBackgroundMenu(background: Background, rl: readline.Interface) {
  menu(
    background.name,
...
function setBackgroundDescription(background: Background, rl: readline.Interface) {
