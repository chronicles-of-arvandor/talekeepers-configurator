...
export class Skill {
  ...
  static ANIMAL_HANDLING = new Skill(
    "ANIMAL_HANDLING",
    "Animal Handling",
    Ability.WISDOM,
  );
  ...
  static INTIMIDATION = new Skill(
    "INTIMIDATION",
    "Intimidation",
    Ability.CHARISMA,
  );
  static INVESTIGATION = new Skill(
    "INVESTIGATION",
    "Investigation",
  ...
  static SLEIGHT_OF_HAND = new Skill(
    "SLEIGHT_OF_HAND",
    "Sleight of Hand",
    Ability.DEXTERITY,
  );
