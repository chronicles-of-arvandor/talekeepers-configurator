...
export function displaySubAncestryMenu(
  ancestry: Ancestry,
  ...
  menu(
    ...
    option(
      "Dark vision " + gray(`(${subAncestry.darkVision?.value ?? "unset"})`),
      () => {
    ...
    option(
      "Bonus HP per level " +
        gray(`(${subAncestry.bonusHpPerLevel ?? "unset"})`),
      () => {
    ...
    option(red("Delete"), () => {
      ancestry.subAncestries.splice(
        ancestry.subAncestries.indexOf(subAncestry),
        1,
      );
      ancestry.save();
...
function setSubAncestryDarkVision(
  ancestry: Ancestry,
  subAncestry: SubAncestry,
  rl: readline.Interface,
) {
...
function setSubAncestryMinimumAge(
  ancestry: Ancestry,
  subAncestry: SubAncestry,
  rl: readline.Interface,
) {
...
function setSubAncestryMaximumAge(
  ancestry: Ancestry,
  subAncestry: SubAncestry,
  rl: readline.Interface,
) {
...
function setSubAncestryMinimumHeight(
  ancestry: Ancestry,
  subAncestry: SubAncestry,
  rl: readline.Interface,
) {
...
function setSubAncestryMaximumHeight(
  ancestry: Ancestry,
  subAncestry: SubAncestry,
  rl: readline.Interface,
) {
...
function setSubAncestryMinimumWeight(
  ancestry: Ancestry,
  subAncestry: SubAncestry,
  rl: readline.Interface,
) {
...
function setSubAncestryMaximumWeight(
  ancestry: Ancestry,
  subAncestry: SubAncestry,
  rl: readline.Interface,
) {
...
function setSubAncestryBonusHpPerLevel(
  ancestry: Ancestry,
  subAncestry: SubAncestry,
  rl: readline.Interface,
) {
...
function setSubAncestrySkullTexture(
  ancestry: Ancestry,
  subAncestry: SubAncestry,
  rl: readline.Interface,
) {
