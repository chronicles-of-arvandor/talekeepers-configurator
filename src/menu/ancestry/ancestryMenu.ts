...
export function displayAncestryMenu(ancestry: Ancestry, rl: readline.Interface) {
  menu(
    ancestry.name,
    ...
    option('Sub-ancestries ' + gray(`(${ancestry.subAncestries.length})`), () => {
    ...
    option('Bonus HP per level ' + gray(`(${ancestry.bonusHpPerLevel})`), () => {
...
function setAncestryBonusHpPerLevel(ancestry: Ancestry, rl: readline.Interface) {
